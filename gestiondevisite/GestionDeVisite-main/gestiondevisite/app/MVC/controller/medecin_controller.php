...
if(isset($_REQUEST['functionSee'])){
    ...
    $medecinData = $medecinDATA->getInfosMedecins($_GET['functionSee']); //voir les infos d'un médecins
    $rapportMedecin = $medecinDATA->getRapportMedecin($_GET['functionSee']); //avoir ses rapports
...
elseif(isset($_REQUEST["functionModif"])){
    ...
    $medecinData = $medecinDATA->getInfosMedecins($_GET['functionModif']);  //modifier uniquement ses infos a lui
    $rapportMedecin = $medecinDATA->getRapportMedecin($_GET['functionModif']); //avoir ses rapports
